#include "dtypes.h"
!===================================================
! DO NOT EDIT THIS FILE, it was generated using /home/micael/genf90.pl
...
# 69 "CDEPS/share/shr_infnan_mod.F90.in"
...
# 75 "CDEPS/share/shr_infnan_mod.F90.in"
...
# 80 "CDEPS/share/shr_infnan_mod.F90.in"
...
# 85 "CDEPS/share/shr_infnan_mod.F90.in"
...
# 110 "CDEPS/share/shr_infnan_mod.F90.in"
...
# 120 "CDEPS/share/shr_infnan_mod.F90.in"
interface shr_infnan_to_r8
   module procedure nan_r8
   module procedure inf_r8
end interface

# 125 "CDEPS/share/shr_infnan_mod.F90.in"
...
# 165 "CDEPS/share/shr_infnan_mod.F90.in"
contains
...
! TYPE double,real
# 174 "CDEPS/share/shr_infnan_mod.F90.in"
...
# 180 "CDEPS/share/shr_infnan_mod.F90.in"
...
! TYPE double,real
# 191 "CDEPS/share/shr_infnan_mod.F90.in"
...
# 201 "CDEPS/share/shr_infnan_mod.F90.in"
...
! TYPE double,real
# 204 "CDEPS/share/shr_infnan_mod.F90.in"
...
# 214 "CDEPS/share/shr_infnan_mod.F90.in"
...
! TYPE double,real
# 222 "CDEPS/share/shr_infnan_mod.F90.in"
...
# 228 "CDEPS/share/shr_infnan_mod.F90.in"
...
! TYPE double,real
# 238 "CDEPS/share/shr_infnan_mod.F90.in"
elemental function shr_infnan_isposinf_double(x) result(isposinf)
  real(r8), intent(in) :: x
  logical :: isposinf
#if (102 == TYPEREAL)
...
# 249 "CDEPS/share/shr_infnan_mod.F90.in"
end function shr_infnan_isposinf_double
! TYPE double,real
# 238 "CDEPS/share/shr_infnan_mod.F90.in"
elemental function shr_infnan_isposinf_real(x) result(isposinf)
...
! TYPE double,real
# 252 "CDEPS/share/shr_infnan_mod.F90.in"
elemental function shr_infnan_isneginf_double(x) result(isneginf)
  real(r8), intent(in) :: x
  logical :: isneginf
#if (102 == TYPEREAL)
...
# 263 "CDEPS/share/shr_infnan_mod.F90.in"
end function shr_infnan_isneginf_double
! TYPE double,real
# 252 "CDEPS/share/shr_infnan_mod.F90.in"
elemental function shr_infnan_isneginf_real(x) result(isneginf)
...
! TYPE double,real
! DIMS 0,1,2,3,4,5,6,7
# 286 "CDEPS/share/shr_infnan_mod.F90.in"
...
# 324 "CDEPS/share/shr_infnan_mod.F90.in"
...
! TYPE double,real
! DIMS 0,1,2,3,4,5,6,7
# 328 "CDEPS/share/shr_infnan_mod.F90.in"
...
# 366 "CDEPS/share/shr_infnan_mod.F90.in"
...
# 374 "CDEPS/share/shr_infnan_mod.F90.in"
...
# 380 "CDEPS/share/shr_infnan_mod.F90.in"
end function nan_r8

# 382 "CDEPS/share/shr_infnan_mod.F90.in"
...
# 388 "CDEPS/share/shr_infnan_mod.F90.in"
end function nan_r4

# 390 "CDEPS/share/shr_infnan_mod.F90.in"
...
# 396 "CDEPS/share/shr_infnan_mod.F90.in"
end function inf_r8

# 398 "CDEPS/share/shr_infnan_mod.F90.in"
...
# 404 "CDEPS/share/shr_infnan_mod.F90.in"
end function inf_r4
