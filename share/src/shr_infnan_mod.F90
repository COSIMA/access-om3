...
# 69 "CESM_share/src/shr_infnan_mod.F90.in"
...
# 75 "CESM_share/src/shr_infnan_mod.F90.in"
...
# 80 "CESM_share/src/shr_infnan_mod.F90.in"
...
# 85 "CESM_share/src/shr_infnan_mod.F90.in"
...
# 110 "CESM_share/src/shr_infnan_mod.F90.in"
...
# 120 "CESM_share/src/shr_infnan_mod.F90.in"
interface shr_infnan_to_r8
   module procedure nan_r8
   module procedure inf_r8
end interface

# 125 "CESM_share/src/shr_infnan_mod.F90.in"
...
# 165 "CESM_share/src/shr_infnan_mod.F90.in"
contains
...
! TYPE double,real
# 174 "CESM_share/src/shr_infnan_mod.F90.in"
...
# 180 "CESM_share/src/shr_infnan_mod.F90.in"
...
! TYPE double,real
# 191 "CESM_share/src/shr_infnan_mod.F90.in"
...
# 201 "CESM_share/src/shr_infnan_mod.F90.in"
...
! TYPE double,real
# 204 "CESM_share/src/shr_infnan_mod.F90.in"
...
# 214 "CESM_share/src/shr_infnan_mod.F90.in"
...
! TYPE double,real
# 222 "CESM_share/src/shr_infnan_mod.F90.in"
...
# 228 "CESM_share/src/shr_infnan_mod.F90.in"
...
! TYPE double,real
# 238 "CESM_share/src/shr_infnan_mod.F90.in"
elemental function shr_infnan_isposinf_double(x) result(isposinf)
  real(r8), intent(in) :: x
  logical :: isposinf
#if (102 == TYPEREAL)
...
# 249 "CESM_share/src/shr_infnan_mod.F90.in"
end function shr_infnan_isposinf_double
! TYPE double,real
# 238 "CESM_share/src/shr_infnan_mod.F90.in"
elemental function shr_infnan_isposinf_real(x) result(isposinf)
...
! TYPE double,real
# 252 "CESM_share/src/shr_infnan_mod.F90.in"
elemental function shr_infnan_isneginf_double(x) result(isneginf)
  real(r8), intent(in) :: x
  logical :: isneginf
#if (102 == TYPEREAL)
...
# 263 "CESM_share/src/shr_infnan_mod.F90.in"
end function shr_infnan_isneginf_double
! TYPE double,real
# 252 "CESM_share/src/shr_infnan_mod.F90.in"
elemental function shr_infnan_isneginf_real(x) result(isneginf)
...
! TYPE double,real
! DIMS 0,1,2,3,4,5,6,7
# 286 "CESM_share/src/shr_infnan_mod.F90.in"
...
# 324 "CESM_share/src/shr_infnan_mod.F90.in"
...
! TYPE double,real
! DIMS 0,1,2,3,4,5,6,7
# 328 "CESM_share/src/shr_infnan_mod.F90.in"
...
# 366 "CESM_share/src/shr_infnan_mod.F90.in"
...
# 374 "CESM_share/src/shr_infnan_mod.F90.in"
...
# 380 "CESM_share/src/shr_infnan_mod.F90.in"
end function nan_r8

# 382 "CESM_share/src/shr_infnan_mod.F90.in"
...
# 388 "CESM_share/src/shr_infnan_mod.F90.in"
end function nan_r4

# 390 "CESM_share/src/shr_infnan_mod.F90.in"
...
# 396 "CESM_share/src/shr_infnan_mod.F90.in"
end function inf_r8

# 398 "CESM_share/src/shr_infnan_mod.F90.in"
...
# 404 "CESM_share/src/shr_infnan_mod.F90.in"
end function inf_r4
